...
import 'package:apryt/core/network/handler/failed_response.dart';
...
class ApiService {
  ...
  Future<ApiResult<List<Product>>> getAllProducts({int limit = 10, int skip = 0, List<String> select = const ['title', 'price', 'images']}) async {
    try {
